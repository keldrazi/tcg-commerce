...
export class BuylistImportProductCardProviderService {
    ...
    async processBuylistImportProductCardCards(buylistImportProductCardFile: Express.Multer.File, buylistImportProductCardId: string, buylistImportProductCardProviderTypeCode: string): Promise<BuylistImportProductCardProviderDTO[] | null> {
    ...
    async processBuylistImportProductCardCSVData(buylistImportProductCardCSVData: any, buylistImportProductCardProviderTypeDataKeyQty: string): Promise<{ totalbuylistImportProductCardCardQty: number; buylistImportProductCardCardData: any[] }> {
