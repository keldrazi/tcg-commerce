...
import { TCGdbPokemonPriceChangeYearlyDTO } from './dto/tcgdb.pokemon.price.change.yearly.dto';
...
export class TCGdbPokemonPriceChangeYearlyService {
    ...
    async getTCGdbPokemonPriceChangeWeeklyBySet(setCode: string) {
        ...
        const url = this.tcgdbAPIURL + '/tcgdb/pokemon/price/change/yearly/set/' + setCode;
