...
import { TCGdbPokemonPriceChangeWeeklyDTO } from './dto/tcgdb.pokemon.price.change.weekly.dto';
...
export class TCGdbPokemonPriceChangeWeeklyService {
    ...
    async getTCGdbPokemonPriceChangeWeeklyBySet(setCode: string) {
        ...
        const url = this.tcgdbAPIURL + '/tcgdb/pokemon/price/change/weekly/set/' + setCode;
