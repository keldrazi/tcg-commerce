...
import { TCGdbMTGPriceChangeWeeklyModule } from 'src/tcgdb/modules/tcgdb/mtg/price/change/weekly/tcgdb.mtg.price.change.weekly.module';
import { TCGdbMTGPriceChangeMonthlyModule } from 'src/tcgdb/modules/tcgdb/mtg/price/change/monthly/tcgdb.mtg.price.change.monthly.module';
import { TCGdbMTGPriceChangeYearlyModule } from 'src/tcgdb/modules/tcgdb/mtg/price/change/yearly/tcgdb.mtg.price.change.yearly.module';
